...
# Função para aplicar filtros para conversas resolvidas pelo bot
def apply_bot_resolution_filter(data):
    return data[
        (data['closeReasonDescription'] == "BRAND_AUTO_CLOSE") &
        (data['closeReason'] == "TIMEOUT") &
        (data['source'] == "WhatsApp Business") &
        (data['latestAgentFullName'] == "Assistente Virtual")
    ]

# Carregar as bases de dados
data_2023 = pd.read_csv(outubro2023_path)
data_2024 = pd.read_csv(outubro2024_path)
...
# Taxa de Escalamento para Humanos com filtros
filtered_data_2023 = apply_bot_resolution_filter(data_2023)
filtered_data_2024 = apply_bot_resolution_filter(data_2024)

resolved_by_ia_2023 = filtered_data_2023.shape[0]
resolved_by_ia_2024 = filtered_data_2024.shape[0]

escalated_to_human_2023 = data_2023[(data_2023['messageCountAgentHuman'] > 0) & (data_2023['latestAgentFullName'] != "Assistente Virtual")].shape[0]
escalated_to_human_2024 = data_2024[(data_2024['messageCountAgentHuman'] > 0) & (data_2024['latestAgentFullName'] != "Assistente Virtual")].shape[0]
